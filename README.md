...
| --- | --- | --- |
| [RNN Volatility Lab](https://github.com/SRG-eddieliu/rnn-volatility-lab) | [2-page brief](https://github.com/SRG-eddieliu/rnn-volatility-lab/blob/main/reports/volatility-research-brief.pdf) / [Full report](https://github.com/SRG-eddieliu/rnn-volatility-lab/blob/main/reports/volatility-final-report.pdf): GARCH/LSTM/GRU comparison and loss-function tradeoffs | Historical walk-forward study; offline demo and regression tests; single-seed limits disclosed |
